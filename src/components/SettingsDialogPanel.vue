<template>
  <div class="settings-panel">
    <q-expansion-item
      ...
      group="settings-category-group"
    >
      <div class="settings-row">
        <div class="settings-label">Show markers</div>
        <q-toggle v-model="settingsStore.recorder.showMarkers" color="orange" />
      </div>
    </q-expansion-item>
    <q-expansion-item
      expand-separator
        ...
        <div class="settings-row">
          ...
          >
            <q-list style="background-color: var(--bkgColor)">
              ...
              >
                <q-item-section>
                  <q-item-label class="listLabel"
                    >Best performance</q-item-label
                  >
                </q-item-section>
              </q-item>
              <q-item
